...
const ConfigManager = toweran.ConfigManager
...
class App {
  ...
  register(options = {}) {
    ...
    /** @type {ConfigManager} */
    this._configManager = this._container.get('configManager')

    console.log(this._configManager)
  ...
  async start() {
     ...
     */
    await this._eventManager.dispatch('start_application')

    await this._eventManager.dispatch('after_application_started')
