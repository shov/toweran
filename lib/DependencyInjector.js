...
class DependencyInjector {
  ...
  constructor(logger, config, container, scriptLoader, annotationInspector) {
     ...
     * @type {symbol}
     */
    this.DEFAULT_STRATEGY = C.DI.DOT_NOTATION
  }
   ...
   * @param {*[]} args
   */
  registerClass(pattern, filePath, strategy = C.DI.DOT_NOTATION, ...args) {
   ...
   * @param {*[]} args
   */
  registerClassStrict(pattern, filePath, strategy = C.DI.DOT_NOTATION, ...args) {
    must.be.notEmptyString(pattern)
      .and.be.notEmptyString(filePath)
